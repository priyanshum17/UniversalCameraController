...
class AppController:
    ...
    def set_frame_callback(self, callback: Callable[[str, bytes, int, int], None]) -> None:
        """
    ...
    def start_recording(self) -> None:
        ...
        logger.info(f"AppController: Starting recording session for {self.selected_cam_id}")
        self.is_recording = True
        
        self.camera_service.start_camera(self.selected_cam_id, self._internal_frame_router)
    ...
    def stop_recording(self) -> None:
        ...
        recorded_path: Optional[str] = self.camera_service.stop_camera(self.selected_cam_id)
    ...
    def _internal_frame_router(self, cam_id: str, raw_frame: bytes, width: int, height: int) -> None:
        """
